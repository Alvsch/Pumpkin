...
use crate::structure::structures::stronghold::StrongholdPieceType;
use crate::{
...
pub trait StructurePieceBase: Send + Sync {
    ...
    fn fill_openings(
        ...
        _weights: &mut Vec<crate::structure::structures::stronghold::PieceWeight>,
    ...
    fn fill_openings_nether(
        ...
        _start: &StructurePiece,
        _random: &mut RandomGenerator,
        _bridge_pieces: &mut Vec<crate::structure::structures::nether_fortress::PieceWeight>,
        _corridor_pieces: &mut Vec<crate::structure::structures::nether_fortress::PieceWeight>,
        _collector: &mut StructurePiecesCollector,
        _pieces_to_process: &mut Vec<Box<dyn StructurePieceBase>>,
    ) {
    }
