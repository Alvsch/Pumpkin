...
impl StructureGenerator for NetherFortressGenerator {
    fn get_structure_position(
        ...
        let start_box: Box<dyn crate::structure::structures::StructurePieceBase> =
            Box::new(start_piece.clone());

        let mut pieces_to_process: Vec<Box<dyn crate::structure::structures::StructurePieceBase>> =
            Vec::new();
...
impl NetherFortressPiece {
    #[must_use]
    pub const fn new(
        r#type: crate::structure::piece::StructurePieceType,
        chain_length: u32,
        bbox: BlockBox,
    ) -> Self {
        Self {
    ...
    pub fn pick_piece(
        ...
        chain_length: u32,
    ) -> Option<Box<dyn crate::structure::structures::StructurePieceBase>> {
    ...
    pub fn fill_forward_opening(
        ...
        height_offset: i32,
        inside: bool,
        pieces_to_process: &mut Vec<Box<dyn crate::structure::structures::StructurePieceBase>>,
    ) {
