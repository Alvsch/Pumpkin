...
impl StructurePieceBase for SmallCorridorPiece {
    ...
    fn get_structure_piece(&self) -> &crate::structure::structures::StructurePiece {
        &self.piece.piece
    }

    fn get_structure_piece_mut(&mut self) -> &mut crate::structure::structures::StructurePiece {
        &mut self.piece.piece
    }
