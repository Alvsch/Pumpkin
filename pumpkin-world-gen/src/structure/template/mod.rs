...
//!
//! ```ignore
//! use pumpkin_world::structure::template::{TemplateCache, TemplatePiece, BlockRotation};
//!
...
pub use cache::get_template;
pub use rotation::{BlockMirror, BlockRotation};
pub use structure_template::{PaletteEntry, StructureTemplate};
