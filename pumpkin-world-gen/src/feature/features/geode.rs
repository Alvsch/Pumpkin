...
use pumpkin_world_core::{BlockRegistryExt, BlockStateCodec, RawBlockState};

use crate::feature::features::spring_feature::BlockWrapper;
...
struct NormalNoise(crate::noise::perlin::DoublePerlinNoiseSampler);
...
impl NormalNoise {
    fn create(
        ...
        Self(crate::noise::perlin::DoublePerlinNoiseSampler::new(
            rand,
            first_octave,
            amplitudes,
            amplitude,
...
pub struct GeodeFeature {
    /* Block settings */
    pub filling_provider: crate::block_state_provider::BlockStateProvider,
    pub inner_layer_provider: crate::block_state_provider::BlockStateProvider,
    pub alternate_inner_layer_provider: crate::block_state_provider::BlockStateProvider,
    pub middle_layer_provider: crate::block_state_provider::BlockStateProvider,
    pub outer_layer_provider: crate::block_state_provider::BlockStateProvider,
